...
<template>
  <div class="flex flex-col items-center gap-6">
    <h1
      class="self-stretch rounded-xl border-2 border-zinc-700/60 bg-zinc-800 px-10 py-3 text-center text-2xl font-black uppercase tracking-widest text-orange-100 shadow-md"
    >
      YOUR LIBRARY:
